...
function share(action){
	...
	if( action == 'twitter' ) {
		shareurl = 'https://twitter.com/bchiheb34'+loc+'&text='+text;
	}else if( action == 'facebook' ){
		shareurl = 'https://www.facebook.com/bchiheb34'+encodeURIComponent(loc+'share.php?desc='+text+'&title='+title+'&url='+loc+'&thumb='+loc+'share.jpg&width=590&height=300');
	}else if( action == 'google' ){
		shareurl = 'https://plus.google.com/'+loc;
	}
